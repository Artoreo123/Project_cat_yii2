...
{
    //const ตัวแปรคงที่ ค่าจะไม่เปลี่ยน
    ...
    {
        return [
            [['username','email','password_hash'], 'required','message' => 'กรุณากรอกข้อมูล..{attribute}'],
            [['username','email','password_hash','code'], 'string','max' => 255],
